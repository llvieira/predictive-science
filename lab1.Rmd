...
despesasOrdenadasPorUso %>% ggplot(aes(x=reorder(tipoDespesa, vezesUsado), y=vezesUsado)) + labs(x = "Tipo da Despesa", y = "Total Gasto")+ geom_point(size=3) + geom_segment(aes(x=tipoDespesa, xend=tipoDespesa, y=0, yend=vezesUsado)) +    labs(title="Despesas que mais utilizadas pelos deputados dos partidos(PT, PMDB, PSOL)", subtitle="Tipo da Despesa Vs Vezes usado", caption="source: dados") + coord_flip()

despesasOrdenadasPorGasto %>% ggplot(aes(x=reorder(tipoDespesa, totalGasto), y=totalGasto)) + labs(x = "Tipo da Despesa", y = "Total Gasto")+ geom_point(size=3) + geom_segment(aes(x=tipoDespesa, xend=tipoDespesa, y=0, yend=totalGasto)) +    labs(title="Despesas que mais custosas utilizadas pelos deputados dos partidos(PT, PMDB, PSOL)", subtitle="Tipo da Despesa Vs Total Gasto", caption="source: dados") + coord_flip()
```